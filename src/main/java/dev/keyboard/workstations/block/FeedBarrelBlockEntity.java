 ...
 */
public class FeedBarrelBlockEntity extends RandomizableContainerBlockEntity implements LidBlockEntity {
	...
	private final ContainerOpenersCounter viewers = new ContainerOpenersCounter() {
		...
		public boolean isOwnContainer(Player player) {
			return player.containerMenu instanceof ChestMenu open
					&& open.getContainer() == FeedBarrelBlockEntity.this;
		}
	};
	...
	public static void clientTick(Level world, BlockPos pos, BlockState state, FeedBarrelBlockEntity box) {
		box.lid.tickLid();
	}
	...
	protected Component getDefaultName() {
		return Component.translatable("container.keyboard_workstations.feed_barrel");
	}
