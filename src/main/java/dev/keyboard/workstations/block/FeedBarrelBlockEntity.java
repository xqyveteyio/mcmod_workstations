 ...
 */
public class FeedBarrelBlockEntity extends LootableContainerBlockEntity implements AnimatedLid
		//? if >=1.17 {
		, LidOpenable
		//?} else {
		/* , Tickable */
	...
	/* public FeedBarrelBlockEntity() {
		super(WorkstationsMod.FEED_BARREL_BLOCK_ENTITY);
	} */
	//?}
	...
	protected Text getContainerName() {
		return Mc.translatable("container.keyboard_workstations.feed_barrel");
	}
