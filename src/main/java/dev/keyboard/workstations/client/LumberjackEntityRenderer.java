 ...
 * apart at a glance once a lumberjack skin is drawn; until then it reuses the farmer's files.
 *
 ...
 */
public class LumberjackEntityRenderer extends MobEntityRenderer<LumberjackEntity,
		//? if >=26.1 {
		/* WorkerRenderState, VillagerResemblingModel> { */
		//?} else {
		VillagerResemblingModel<LumberjackEntity>> {
		//?}
	...
	*/
	...
	/** Hands the body to Minecraft Comes Alive, exactly as {@link FarmerEntityRenderer} does. */
	@Override
