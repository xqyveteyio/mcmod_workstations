 ...
 */
public class RancherEntity extends PathfinderMob implements StationWorker, WorkerMob {
	...
	private static final EntityDataAccessor<Integer> SKIN =
			SynchedEntityData.defineId(RancherEntity.class, EntityDataSerializers.INT);
	...
	public RancherEntity(EntityType<? extends RancherEntity> type, Level world) {
		super(type, world);
	...
	public static AttributeSupplier.Builder createRancherAttributes() {
	...
	public RanchBlockEntity getStation() {
		...
		return level().getBlockEntity(stationPos) instanceof RanchBlockEntity station ? station : null;
	}
