...
/**
 * Draws the rancher's work area for debugging: a wireframe box for the whole volume plus a
 * translucent slab at the station's own level, which is the part you actually want to line up
 * with your fences.
 */
public class WorkAreaHighlightRenderer implements BlockEntityRenderer<ScarecrowBlockEntity> {
