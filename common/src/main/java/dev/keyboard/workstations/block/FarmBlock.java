...
public class FarmBlock extends BlockWithEntity {
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		...
		return validateTicker(type, WorkstationsMod.FARM_BLOCK_ENTITY.get(), WorkStationBlockEntity::serverTick);
	}
	...
	public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
		...
		if (placer instanceof PlayerEntity player) {
			player.sendMessage(Text.translatable("message.villager_workstations.farm_placed", plots), true);
		}
	}
