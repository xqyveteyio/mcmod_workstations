...
public abstract class WorkerSettingsScreen<S extends WorkerSettings<S>> extends Screen {
    ...
    protected void init() {
        ...
        for (String category : categories) {
            ...
            Text label = new TranslatableText("config.villager_workstations." + category);
        ...
        addButton(new ButtonWidget(footerX, footerY, footerWidth, CONTROL_HEIGHT,
                new TranslatableText("config.villager_workstations.worker_recall"),
        ...
        addButton(new ButtonWidget(footerX + footerWidth + BUTTON_GAP, footerY, footerWidth, CONTROL_HEIGHT,
                new TranslatableText("config.villager_workstations.reset"),
    ...
    private class OptionList extends ElementListWidget<Row> {
        OptionList(String category, int top, int bottom) {
            ...
            if (WorkerSettings.DISPLAY.equals(category)) {
                addEntry(new Row(new TranslatableText("config.villager_workstations.highlight_always_on"),
                        highlightControl(),
                        new TranslatableText("config.villager_workstations.highlight_always_on.tooltip")));
            }
        }
    ...
    private class MixSlider extends SliderWidget {
        ...
        protected void updateMessage() {
            setMessage(new TranslatableText("config.villager_workstations.seed_weight",
