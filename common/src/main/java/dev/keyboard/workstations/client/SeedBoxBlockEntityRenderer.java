 ...
 */
public class SeedBoxBlockEntityRenderer
		implements BlockEntityRenderer<SeedBoxBlockEntity, SeedBoxBlockEntityRenderer.State> {
	private final SeedBoxModel model;

	public SeedBoxBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(SeedBoxBlockEntity box, State state, float tickDelta, Vec3 camera,
