...
/**
 * Custom {@code builtin/entity} item drawing, registered per loader. Architectury 1.16 has no
 * common hook for this, so Fabric talks to Fabric API and Forge hangs a renderer off the item.
 */
public final class BuiltinItemRenderers {
	...
	public interface DynamicItemRenderer {
		void render(ItemStack stack, ModelTransformation.Mode mode, MatrixStack matrices,
